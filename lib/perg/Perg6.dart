...
class _Screen6State extends State<Perg6> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('CIRCUNFERÊNCIA DA PANTURRILHA',style: TextStyle(
              fontWeight: FontWeight.bold, color: const Color.fromARGB(255, 36, 13, 13), fontSize: 20),)),
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('Você deverá medir a circunferência da sua perna DIREITA em pé, com os pés afastados 20cm e com as pernas relaxadas.',style: TextStyle(fontWeight: FontWeight.bold),),
            SizedBox(height: 20),
            Padding(
